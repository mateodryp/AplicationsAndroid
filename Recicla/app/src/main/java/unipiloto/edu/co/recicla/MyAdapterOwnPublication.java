...
public class MyAdapterOwnPublication  extends BaseAdapter {

    private Context context;
    private int layout;
    private ArrayList<ListOwnPublications> publications;

    public MyAdapterOwnPublication(Context context, int layout, ArrayList<ListOwnPublications> publications) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        v = layoutInflater.inflate(R.layout.list_view_publications_prov, null);
        TextView t1 = (TextView) v.findViewById(R.id.pItem_publication_type_material);
        TextView t2 = (TextView) v.findViewById(R.id.pItem_publication_peso);
        TextView t3 = (TextView) v.findViewById(R.id.pItem_publication_volumen);
        TextView t4 = (TextView) v.findViewById(R.id.pItem_publication_ubicacion);
        ImageView imageView = (ImageView) v.findViewById(R.id.pmaterialImage);
