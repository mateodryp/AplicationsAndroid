...
public class ListOwnRequestPen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_own_request_pen);
        ...
        ImageView history = (ImageView) findViewById(R.id.Rec_Sol_Pen_history);
        ...
        Call<List<ListOwnRequest>> call = RetrofitClient.getApiService().getListOwnRequestPen(Integer.parseInt(id));
        call.enqueue(new Callback<List<ListOwnRequest>>() {
            ...
            public void onResponse(Call<List<ListOwnRequest>> call, Response<List<ListOwnRequest>> response) {
                ...
                ListView listView = (ListView) findViewById(R.id.Rec_Sol_Pen_list);
